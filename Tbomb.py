...
# Author: BD-BOMBER Inc.
# GitHub: https://github.com/ngsiyamff
# Version: 4.1.0
#########################################
...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/ngsiyamff/BD-BOMBER/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf BD-BOMBER && git clone https://github.com/ngsiyamff/BD-BOMBER > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd BD-BOMBER && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : BD-BOMBER Inc.                \033[94m│".center(columns+15))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mBD-BOMBER\n")
        time.sleep(0.6)
